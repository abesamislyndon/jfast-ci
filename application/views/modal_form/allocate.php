   ...
   <div class="col-md-12 margin-bottom-15">
      <div class="form-group">
         ...
         <select class="form-control sum" id="name" name = "name" onchange = "calljavascriptfunction()">
            ...
            <option  value = "<?php echo $value->id ?>"><?php echo $value->driver_name ?></option>
            <?php  } ?>   
         </select>
      </div>
      <div class="form-group">
         <label>Company</label>
         <input type="text" name = "company" id = "company" class="form-control" placeholder="Enter ..." value = ""/>
      </div>
      <div class="form-group">
         <label>address</label>
         <input type="text" name = "address" id = "address" class="form-control" placeholder="Enter ..." value = ""/>
      </div>
          <div class="form-group">
