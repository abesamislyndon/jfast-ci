<div class="content-wrapper">
   <section class="content">
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <div class="box">
               ...
               <!-- /.box-header -->
               <div class="box-body">
                  <?php echo form_open_multipart('costing_attributes/add_labor','id="form1"' );?>  
                  ...
                  <div class="form-group">
                     <label>Labor</label>
                     <input type="text" name = "labor" class="form-control" placeholder="Enter ..." required/>
                  </div>
                  <div class="form-group">
                     <label>Cost</label>
               ...
               <?php echo form_open_multipart('costing_attributes/update_labor','id="form1"' );?>  
                  <!--modal-->
                     ...
                     <div class="modal-dialog">
                        <div class="modal-content">
                           <div class="modal-header header-spec">
                              ...
                              <h4 class="modal-title"> <i class="fa fa-pencil-square-o"></i>&nbsp;Update labor Details</h4>
                           </div>
     ...
     <div class="col-md-6">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">MANAGE LABOR</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
                  <table class="table table-bordered table-custom">
                     ...
                     <tr>
                        ...
                        <td><a href="<?php echo base_url();?>costing_attributes/delete_labor/<?php echo $value->id ?>" onclick="return confirm('Are you sure you want to Delete?');"><span class="badge bg-red custom"><i class="fa fa-trash-o"></i></span></a></td>
                     </tr>
                     <?php endforeach; ?>  
                  </table>
               </div> <!-- /.box-body -->
