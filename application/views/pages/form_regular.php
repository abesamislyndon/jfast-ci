            ...
            <hr>
              ...
              <div class="form-group">
                  <div class="col-md-2">
                   ...
                   <div class="col-md-10">
                      <input type="text" name = "email_deliver" class="form-control lg required" id="exampleInputEmail1" placeholder="Enter email" required/>
                  </div>
               </div>
      ...
      <div class="col-md-12 wrapper1">
         ...
         <div class="form-group">
                  <div class="col-md-2">
                   ...
                   <div class="col-md-10">
                         <select class="form-control  lg required" name="vehicle"  required>
  ...
  <div class="container">
   <div class="row">
      <div class="col-md-12 wrapper1">
       ...
       <div class="col-md-2">    
               <div class="form-group">
                  <label><input type="checkbox" name = "item_type[]" value = "bag" class = "ck3">&nbsp;&nbsp;&nbsp;BAG</label>    
               </div>
       ...
       <div class="col-md-2">    
               <div class="form-group">
                  <label><input type="checkbox" name = "item_type[]" value = "carton" class = "ck4">&nbsp;&nbsp;&nbsp;CARTON</label>    
               </div>
      ...
      <div class="col-md-2">    
               <div class="form-group">
                  <label><input type="checkbox" name = "item_type[]" value = "item" class = "ck5">&nbsp;&nbsp;&nbsp;ITEM</label>    
               </div>
