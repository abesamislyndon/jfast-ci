               ...
               <table class="table table-bordered table-custom">
                  ...
                  <div class='box'>
                     ...
                     <div class='box-body pad'>
                       <textarea class="form-control myTextEditor details2" name = "job_details" rows="3"><?php echo $value->job_details ?></textarea>
                     </div>
                  </div>
                  <?php endforeach; ?>
                  <div class="col-sm-7">
                     <a href="javascript:window.close();" class = "btn btn-success btn-lg">Close</a>
                  </div>
               </form>   
                 <!--end of modal-->
               </div>
